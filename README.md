...
Each model has been trained on the FAST-LUMS Camera Calibration Dataset while Tsinghua-Daimler Dataset has been used only for testing. Each folder contains 2 ipython notebooks, one for FAST-LUMS Dataset while the other for Tsinghua-Daimler Dataset.
